...
class BipartiteGraphDataLoaderCora:
    ...
    def load(self):
        ...
        edge_count = 0
        '''
        print("####u_list = %d" % len(u_list))#1312
        print(type(u_list))#list
        print("####u_attr_dict = %d" % len(u_attr_dict))#1312
        print(type(u_attr_dict))#dict
        print("v_list = %d" % len(v_list))#789
        print(type(v_list))#list
        print("v_attr_dict = %d" % len(v_attr_dict))#789       
        print(type(v_attr_dict))#dict       
        '''
        ...
        '''
        print(type(self.u_adjacent_matrix))#csr
        print(type(self.v_adjacent_matrix))#csr
        print(type(self.u_label))#list
        '''
        # for mini-batch
