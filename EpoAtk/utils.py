...
from EpoAtk.normalization import fetch_normalization, row_normalize
...
def sparse_mx_to_khopsgraph(sp_mx):
    ...
    degree_list_prob = []
    #print(type(degree_dict_prob))#<class 'networkx.classes.reportviews.DegreeView'>
    degree_dict_prob=dict(degree_dict_prob)
