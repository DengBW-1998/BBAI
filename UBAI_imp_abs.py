...
for ite in range(iteration):
    ...
    for _ in range(1):
        ...
        if ite==iteration-1:
            ...
            print('svd our_nn auc:{}'.format(auc_score))
            print('svd our_nn auc:{}'.format(auc_score),file=data)

        adj_nn=adjsp_2_adjnn(adj_matrix_flipped,gul)
        adj_nn=standardize(adj_nn)

time_end=time.time()
print('UBAI_imp_abs') 
print('UBAI_imp_abs',file=data)
