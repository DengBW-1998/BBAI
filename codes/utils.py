...
def generate_candidates_addition(adj_matrix, n_candidates, u, v, seed=0):
    ...
    :return: np.ndarray, shape [?, 2]
        Candidate set of edge flips
    """
    u_candidates = np.random.randint(0, u-1, [n_candidates*2, 1])
    v_candidates = np.random.randint(u, u+v-1, [n_candidates*2, 1])
